...
import type { SwitchProps as AriaSwitchProperties } from "react-aria-components";
import { Switch as AriaSwitch } from "react-aria-components";

interface ToggleBaseProperties {
  size?: "sm" | "md";
  slim?: boolean;
  className?: string;
  isHovered?: boolean;
  ...
  return (
    <div
      className={cx(
        ...
        isSelected && "bg-[#2299D5]",
        isSelected && isHovered && "bg-[#2299D5]",
...
interface ToggleProperties extends AriaSwitchProperties {
  size?: "sm" | "md";
  label?: string;
  hint?: ReactNode;
  slim?: boolean;
