import { cx, sortCx } from "@/shared/lib/utils/cx";
...
import type {
  ...
  TextFieldProps as AriaTextFieldProperties,
...
export interface InputBaseProperties extends TextFieldProperties {
...
export const InputBase = ({
  ...
  ...inputProperties
}: Omit<InputBaseProperties, "label" | "hint">) => {
  ...
  return (
    ...
    >
      ...
      {/* Input field */}
      <AriaInput
        {...(inputProperties as AriaInputProperties)}
        ref={ref}
...
const TextFieldContext = createContext<TextFieldProperties>({});
...
export const TextField = ({
  ...
  return (
    <TextFieldContext.Provider value={properties}>
      <AriaTextField
        {...properties}
        data-input-wrapper
        className={(state) =>
...
interface InputProperties extends InputBaseProperties, BaseProperties {
