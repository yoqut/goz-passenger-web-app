...
import type {
  ...
  TooltipProps as AriaTooltipProperties,
  TooltipTriggerComponentProps as AriaTooltipTriggerComponentProperties,
...
interface TooltipProperties
  extends AriaTooltipTriggerComponentProperties,
    Omit<AriaTooltipProperties, "children"> {
  /**
...
interface TooltipTriggerProperties
  extends AriaButtonProperties,
    RefAttributes<HTMLButtonElement> {}

export const TooltipTrigger = forwardRef<
  HTMLButtonElement,
  TooltipTriggerProperties
>(({ children, className, ...buttonProperties }, ref) => {
  return (
    <AriaButton
      ref={ref}
      {...buttonProperties}
