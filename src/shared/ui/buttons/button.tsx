...
export interface ButtonProperties
  ...
  slot?: AriaButtonProperties["slot"];
}
...
export type Props = ButtonProperties | LinkProperties;
...
export const Button = ({
  ...
  const href = "href" in otherProperties ? otherProperties.href : undefined;
  ...
  if (href) {
    ...
    properties = {
      ...
      type: otherProperties.type || "button",
      isPending: loading,
      isDisabled: disabled,
    };
  }
